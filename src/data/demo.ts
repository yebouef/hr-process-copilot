...
Jordan Lee, People Analytics Manager: Turnover reporting takes several days each month because we export from the HR system and combine files manually. Leadership wants a consistent dashboard from the curated data layer.
